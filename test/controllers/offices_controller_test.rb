...
class OfficesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create office" do
    assert_difference('Office.count') do
      post offices_url, params: { office: { department: @office.department, name: @office.name, salary: @office.salary } }
    end
  ...
  test "should update office" do
    patch office_url(@office), params: { office: { department: @office.department, name: @office.name, salary: @office.salary } }
